...
plt.title(r'График зависимости времени работы Стратегии A при равномерном распределении запросов по массиву(без поправкой на количество запросов)', fontsize=14)
plt.grid(True)
