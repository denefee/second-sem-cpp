...
for i in np.arange(50, 4000, 50):
    x = np.append(x, np.log(i))

f = open('out2-time.txt')
for line in f:
...
plt.title(r'Линеаризованный график зависимости времени работы сортировки Шелла от размера массива при среднем случае (k $\approx$ 1.57)', fontsize=14)
plt.grid(True)
