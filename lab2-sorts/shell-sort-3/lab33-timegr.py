...
plt.title(r'Линеаризованный график зависимости времени работы сортировки Шелла от размера массива при среднем случае (k $\approx$ 1.82)', fontsize=14)
plt.grid(True)
