...
plt.title(r'Линеаризованный график зависимости перестановок сортировки Шелла от размера массива при среднем случае (k $\approx$ 1.99)', fontsize=14)
plt.grid(True)
